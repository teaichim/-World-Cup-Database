...
--
-- Name: games games_fk1; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT games_fk1 FOREIGN KEY (winner_id) REFERENCES public.teams(team_id);


--
-- Name: games games_fk2; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT games_fk2 FOREIGN KEY (opponent_id) REFERENCES public.teams(team_id);
